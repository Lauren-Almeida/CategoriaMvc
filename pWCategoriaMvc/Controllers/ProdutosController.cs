...
namespace CategoriaMvc.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ProdutoViewModel>>
            CriarNovoProduto(ProdutoViewModel produtoVM)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<CategoriaViewModel>> AtualizarProduto(int id,
